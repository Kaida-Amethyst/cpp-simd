...
void __vv_le(vv_float &dst, vv_float src1, vv_float src2);
void __vv_le(vv_float &dst, vv_float src1, float src2);
void __vv_le(vv_int32 &dst, vv_int32 src1, vv_int32 src2);
void __vv_le(vv_int32 &dst, vv_int32 src1, int src2);
void __vv_le(vv_int8 &dst, vv_int8 src1, vv_int8 src2);
void __vv_le(vv_int8 &dst, vv_int8 src1, int8_t src2);
void __vv_le(vv_int16 &dst, vv_int16 src1, vv_int16 src2);
void __vv_le(vv_int16 &dst, vv_int16 src1, int16_t src2);
void __vv_le(vv_uint32 &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_le(vv_uint32 &dst, vv_uint32 src1, uint32_t src2);
void __vv_le(vv_uint8 &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_le(vv_uint8 &dst, vv_uint8 src1, uint8_t src2);
void __vv_le(vv_uint16 &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_le(vv_uint16 &dst, vv_uint16 src1, uint16_t src2);

void __vv_gt(vv_float &dst, vv_float src1, vv_float src2);
void __vv_gt(vv_float &dst, vv_float src1, float src2);
void __vv_gt(vv_int32 &dst, vv_int32 src1, vv_int32 src2);
void __vv_gt(vv_int32 &dst, vv_int32 src1, int src2);
void __vv_gt(vv_int8 &dst, vv_int8 src1, vv_int8 src2);
void __vv_gt(vv_int8 &dst, vv_int8 src1, int8_t src2);
void __vv_gt(vv_int16 &dst, vv_int16 src1, vv_int16 src2);
void __vv_gt(vv_int16 &dst, vv_int16 src1, int16_t src2);
void __vv_gt(vv_uint32 &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_gt(vv_uint32 &dst, vv_uint32 src1, uint32_t src2);
void __vv_gt(vv_uint8 &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_gt(vv_uint8 &dst, vv_uint8 src1, uint8_t src2);
void __vv_gt(vv_uint16 &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_gt(vv_uint16 &dst, vv_uint16 src1, uint16_t src2);
...
// ==, != , <, <=, >, >=
void __vv_setpred_eq(vv_bool &dst, vv_float src1, vv_float src2);
void __vv_setpred_eq(vv_bool &dst, vv_float src1, float src2);
void __vv_setpred_eq(vv_bool &dst, vv_int32 src1, vv_int32 src2);
void __vv_setpred_eq(vv_bool &dst, vv_int32 src1, int src2);
void __vv_setpred_eq(vv_bool &dst, vv_int8 src1, vv_int8 src2);
void __vv_setpred_eq(vv_bool &dst, vv_int8 src1, int src2);
void __vv_setpred_eq(vv_bool &dst, vv_int16 src1, vv_int16 src2);
void __vv_setpred_eq(vv_bool &dst, vv_int16 src1, int src2);
void __vv_setpred_eq(vv_bool &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_setpred_eq(vv_bool &dst, vv_uint32 src1, int src2);
void __vv_setpred_eq(vv_bool &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_setpred_eq(vv_bool &dst, vv_uint8 src1, int src2);
void __vv_setpred_eq(vv_bool &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_setpred_eq(vv_bool &dst, vv_uint16 src1, int src2);

void __vv_setpred_ne(vv_bool &dst, vv_float src1, vv_float src2);
void __vv_setpred_ne(vv_bool &dst, vv_float src1, float src2);
void __vv_setpred_ne(vv_bool &dst, vv_int32 src1, vv_int32 src2);
void __vv_setpred_ne(vv_bool &dst, vv_int32 src1, int src2);
void __vv_setpred_ne(vv_bool &dst, vv_int8 src1, vv_int8 src2);
void __vv_setpred_ne(vv_bool &dst, vv_int8 src1, int src2);
void __vv_setpred_ne(vv_bool &dst, vv_int16 src1, vv_int16 src2);
void __vv_setpred_ne(vv_bool &dst, vv_int16 src1, int src2);
void __vv_setpred_ne(vv_bool &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_setpred_ne(vv_bool &dst, vv_uint32 src1, int src2);
void __vv_setpred_ne(vv_bool &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_setpred_ne(vv_bool &dst, vv_uint8 src1, int src2);
void __vv_setpred_ne(vv_bool &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_setpred_ne(vv_bool &dst, vv_uint16 src1, int src2);

void __vv_setpred_gt(vv_bool &dst, vv_float src1, vv_float src2);
void __vv_setpred_gt(vv_bool &dst, vv_float src1, float src2);
void __vv_setpred_gt(vv_bool &dst, vv_int32 src1, vv_int32 src2);
void __vv_setpred_gt(vv_bool &dst, vv_int32 src1, int src2);
void __vv_setpred_gt(vv_bool &dst, vv_int8 src1, vv_int8 src2);
void __vv_setpred_gt(vv_bool &dst, vv_int8 src1, int src2);
void __vv_setpred_gt(vv_bool &dst, vv_int16 src1, vv_int16 src2);
void __vv_setpred_gt(vv_bool &dst, vv_int16 src1, int src2);
void __vv_setpred_gt(vv_bool &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_setpred_gt(vv_bool &dst, vv_uint32 src1, int src2);
void __vv_setpred_gt(vv_bool &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_setpred_gt(vv_bool &dst, vv_uint8 src1, int src2);
void __vv_setpred_gt(vv_bool &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_setpred_gt(vv_bool &dst, vv_uint16 src1, int src2);

void __vv_setpred_lt(vv_bool &dst, vv_float src1, vv_float src2);
void __vv_setpred_lt(vv_bool &dst, vv_float src1, float src2);
void __vv_setpred_lt(vv_bool &dst, vv_int32 src1, vv_int32 src2);
void __vv_setpred_lt(vv_bool &dst, vv_int32 src1, int src2);
void __vv_setpred_lt(vv_bool &dst, vv_int8 src1, vv_int8 src2);
void __vv_setpred_lt(vv_bool &dst, vv_int8 src1, int src2);
void __vv_setpred_lt(vv_bool &dst, vv_int16 src1, vv_int16 src2);
void __vv_setpred_lt(vv_bool &dst, vv_int16 src1, int src2);
void __vv_setpred_lt(vv_bool &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_setpred_lt(vv_bool &dst, vv_uint32 src1, int src2);
void __vv_setpred_lt(vv_bool &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_setpred_lt(vv_bool &dst, vv_uint8 src1, int src2);
void __vv_setpred_lt(vv_bool &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_setpred_lt(vv_bool &dst, vv_uint16 src1, int src2);

void __vv_setpred_ge(vv_bool &dst, vv_float src1, vv_float src2);
void __vv_setpred_ge(vv_bool &dst, vv_float src1, float src2);
void __vv_setpred_ge(vv_bool &dst, vv_int32 src1, vv_int32 src2);
void __vv_setpred_ge(vv_bool &dst, vv_int32 src1, int src2);
void __vv_setpred_ge(vv_bool &dst, vv_int8 src1, vv_int8 src2);
void __vv_setpred_ge(vv_bool &dst, vv_int8 src1, int src2);
void __vv_setpred_ge(vv_bool &dst, vv_int16 src1, vv_int16 src2);
void __vv_setpred_ge(vv_bool &dst, vv_int16 src1, int src2);
void __vv_setpred_ge(vv_bool &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_setpred_ge(vv_bool &dst, vv_uint32 src1, int src2);
void __vv_setpred_ge(vv_bool &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_setpred_ge(vv_bool &dst, vv_uint8 src1, int src2);
void __vv_setpred_ge(vv_bool &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_setpred_ge(vv_bool &dst, vv_uint16 src1, int src2);

void __vv_setpred_le(vv_bool &dst, vv_float src1, vv_float src2);
void __vv_setpred_le(vv_bool &dst, vv_float src1, float src2);
void __vv_setpred_le(vv_bool &dst, vv_int32 src1, vv_int32 src2);
void __vv_setpred_le(vv_bool &dst, vv_int32 src1, int src2);
void __vv_setpred_le(vv_bool &dst, vv_int8 src1, vv_int8 src2);
void __vv_setpred_le(vv_bool &dst, vv_int8 src1, int src2);
void __vv_setpred_le(vv_bool &dst, vv_int16 src1, vv_int16 src2);
void __vv_setpred_le(vv_bool &dst, vv_int16 src1, int src2);
void __vv_setpred_le(vv_bool &dst, vv_uint32 src1, vv_uint32 src2);
void __vv_setpred_le(vv_bool &dst, vv_uint32 src1, int src2);
void __vv_setpred_le(vv_bool &dst, vv_uint8 src1, vv_uint8 src2);
void __vv_setpred_le(vv_bool &dst, vv_uint8 src1, int src2);
void __vv_setpred_le(vv_bool &dst, vv_uint16 src1, vv_uint16 src2);
void __vv_setpred_le(vv_bool &dst, vv_uint16 src1, int src2);
